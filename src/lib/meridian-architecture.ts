...
export const MERIDIAN_FEATURE_COVERAGE: FeatureCoverage[] = [
  ...
  { id: "twin", name: "Market Twin", cmcBacked: false, meridianLayer: true, status: "live", skillOrModule: "Historical analog engine" },
  { id: "analog", name: "Historical analog search", cmcBacked: false, meridianLayer: true, status: "live", skillOrModule: "Genome similarity" },
