...
export const HISTORICAL_ANALOGS: HistoricalAnalog[] = [
  ...
  {
    id: "nov-2025",
    label: "November 2025 alt rotation",
    period: "Nov 2025",
    regime: "neutral",
    fearGreed: 41,
    rsi: 52,
    change7d: 2.4,
    breadth: 48,
    outcomes: { BNB: 10, CAKE: 18, FLOKI: 22, XVS: 8 },
    differencesTemplate: ["Breadth thinner today", "Meme leadership stronger", "Funding neutral"],
    implication: "Leader-dependent tape — relative strength and liquidity gates dominate.",
  },
  {
    id: "mar-2026",
    label: "March 2026 risk-off tape",
    period: "Mar 2026",
    regime: "risk-off",
    fearGreed: 21,
    rsi: 44,
    change7d: -6.2,
    breadth: 35,
    outcomes: { BNB: 9, CAKE: 15, FLOKI: 8, XVS: 5 },
    differencesTemplate: ["Fear & Greed similar", "Volume lighter", "Breadth recovering"],
    implication: "Capitulation-adjacent — half-size until breadth confirms.",
  },
  {
    id: "jun-2026",
    label: "June 2026 low-breadth chop",
    period: "Jun 2026",
    regime: "neutral",
    fearGreed: 28,
    rsi: 50,
    change7d: -1.2,
    breadth: 42,
    outcomes: { BNB: 6, CAKE: 11, FLOKI: 14, XVS: 4 },
    differencesTemplate: ["Sentiment aligned", "RS leaders rotating", "Vol compressed"],
    implication: "Selective entries only — constitution veto on thin liquidity.",
  },
];
